...
function showCustomsOptions() {
    const div = document.createElement('div');
    div.className = 'msg bot';
    div.innerHTML = '<div class="bubble">For Customs Clearance, please:<br><br>📞 Call us directly at <strong>+91 96116 60204</strong><br><br>📝 Or share your details below and we will call you back.</div>';
    document.getElementById('msgs').appendChild(div);
    div.scrollIntoView({ behavior: 'smooth' });
...
async function sendChat() {
    ...
    if (step === 'phone') {
        ...
        if (currentService === 'customs') {
            addMsg('Thank you ' + userName + '! Our customs team will call you back shortly at ' + (userPhone !== 'skip' ? userPhone : 'your number') + '.', false);
            addMsg('For urgent assistance, please call +91 96116 60204 directly.', false);
        } else {
