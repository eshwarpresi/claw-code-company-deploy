...
<html>
<head>
    <title>PAS Freight Services Pvt Ltd - AI Assistant</title>
    <meta charset="UTF-8">
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .company-full { font-size: 10px; opacity: 0.8; margin-top: 3px; }
        .tagline { font-size: 10px; opacity: 0.75; margin-top: 5px; }
        .status-badge {
        ...
        .messages-area::-webkit-scrollbar-track { background: #e2e8f0; }
        .messages-area::-webkit-scrollbar-thumb { background: #94a3b8; border-radius: 4px; }
        ...
        .user-message .bubble { background: #1a3c5e; color: white; border-bottom-right-radius: 4px; }
        .bot-message .bubble { background: white; color: #1e293b; border: 1px solid #e2e8f0; border-bottom-left-radius: 4px; box-shadow: 0 1px 2px rgba(0,0,0,0.03); }
        .quick-actions {
            padding: 16px 20px;
            background: white;
        ...
        .action-btn:hover { background: #1a3c5e; color: white; transform: translateY(-1px); }
        .input-area {
            padding: 16px 20px;
            background: white;
            border-top: 1px solid #e2e8f0;
        ...
        .input-area button:hover { background: #0f2b45; transform: scale(0.98); }
        .sub-buttons { display: flex; gap: 8px; margin-top: 10px; flex-wrap: wrap; }
        .sub-btn {
            padding: 6px 14px;
            background: #e2e8f0;
            color: #1e293b;
        ...
        .sub-btn:hover { background: #cbd5e1; transform: translateY(-1px); }
        .typing-indicator { display: inline-flex; gap: 4px; padding: 4px 0; }
        .typing-indicator span { width: 6px; height: 6px; background: #94a3b8; border-radius: 50%; animation: pulse 1.4s infinite; }
        .typing-indicator span:nth-child(2) { animation-delay: 0.2s; }
        .typing-indicator span:nth-child(3) { animation-delay: 0.4s; }
        @keyframes pulse { 0%, 60%, 100% { transform: scale(1); opacity: 0.5; } 30% { transform: scale(1.2); opacity: 1; } }
        .welcome-title { font-size: 16px; font-weight: 700; color: #0a2647; margin-bottom: 8px; }
        .welcome-text { font-size: 13px; color: #475569; line-height: 1.5; }
        .service-list { margin: 10px 0; padding-left: 20px; }
        .service-list li { margin: 5px 0; color: #334155; }
    </style>
</head>
<body>
<div class="chat-container">
    <div class="chat-header">
        <div class="logo">
            ...
            <span class="logo-text">PAS Freight Services Pvt Ltd</span>
        </div>
        <div class="company-full">PAS FREIGHT SERVICES PRIVATE LIMITED</div>
        <div class="tagline">Logistics & Freight Solutions | Bangalore</div>
    ...
    <div class="messages-area" id="messagesArea">
        <div class="message bot-message">
            <div class="bubble">
                <div class="welcome-title">✨ Welcome to PAS Freight Services Pvt Ltd</div>
...
document.getElementById('importBtn').onclick = function() { selectService('import'); };
document.getElementById('exportBtn').onclick = function() { selectService('export'); };
document.getElementById('customsBtn').onclick = function() { selectService('customs'); };
document.getElementById('domesticBtn').onclick = function() { selectService('domestic'); };
document.getElementById('courierBtn').onclick = function() { selectService('courier'); };
document.getElementById('aboutBtn').onclick = function() { showAbout(); };
document.getElementById('sendBtn').onclick = function() { sendChat(); };
...
if __name__ == '__main__':
    print("=" * 50)
    print("🚀 PAS Freight Services Pvt Ltd - AI Assistant")
