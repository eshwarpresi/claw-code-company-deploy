...
function customsOptions() {
    const div = document.createElement('div');
    div.className = 'msg bot';
    div.innerHTML = '<div class="bubble">📋 Customs Clearance<br><br>📞 Call us: <strong>+91 96116 60204</strong><br><br>📝 Or share your details below.</div>';
    document.getElementById('msgs').appendChild(div);
    div.scrollIntoView({ behavior: 'smooth' });
    step = 'name';
...
async function sendMsg() {
    ...
    if (step === 'phone') {
        ...
        if (currentService === 'customs') {
            addMsg('Thanks ' + userName + '! Our customs team will call you back.', false);
            addMsg('Urgent? Call +91 96116 60204', false);
        } else {
            addMsg('Thanks ' + userName + '! We will contact you within 24 hours.', false);
            addMsg('Call +91 9071660066 for immediate help', false);
        }
...
if __name__ == '__main__':
    print("=" * 50)
    print("🚀 PAS Freight AI - CLEAN VERSION")
