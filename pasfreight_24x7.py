...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .about-text strong { color: #1e3c72; }
    </style>
</head>
<body>
<div class="chat-box">
...
function showServiceContact(service, mode) {
    ...
    if (service === 'import' || service === 'export') {
        phoneNumber = '+91 90716 60066';
        serviceName = (service === 'import' ? 'IMPORT' : 'EXPORT') + ' (' + mode.toUpperCase() + ')';
    } else if (service === 'customs') {
        phoneNumber = '+91 63615 26664';
        serviceName = 'CUSTOMS CLEARANCE';
    } else if (service === 'domestic' || service === 'courier') {
        phoneNumber = '+91 96116 60204';
        serviceName = service === 'domestic' ? 'DOMESTICS' : 'COURIER';
    }
...
async function sendMsg() {
    ...
    if (step === 'phone') {
        ...
        let phoneDisplay = '';
        if (currentService === 'import' || currentService === 'export') {
            phoneDisplay = '+91 90716 60066';
        } else if (currentService === 'customs') {
            phoneDisplay = '+91 63615 26664';
        } else {
            phoneDisplay = '+91 96116 60204';
        }
        
        addMsg('Thanks ' + userName + '! Our team will call you back shortly.', false);
        addMsg('For immediate assistance, call ' + phoneDisplay, false);
