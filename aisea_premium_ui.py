...
<head>
    ...
    <style>
        * {
        ...
        /* Quick Reply Buttons - Only 3 main buttons */
        .quick-reply {
            display: flex;
            flex-wrap: wrap;
            gap: 10px;
    ...
    <div id="pasfreight-chat-window">
        ...
        <div class="chat-messages" id="chatMessages">
            <div class="message bot-message">
                <div class="bubble">Hi, I'm Aisea 👋<br><br>Need help with shipping? Let me guide you.</div>
            </div>
            <div class="message bot-message">
                <div class="bubble">
                    <div class="quick-reply">
                        <button class="quick-btn" onclick="sendQuick('Get a quote')">💰 Get Quote</button>
                        <button class="quick-btn" onclick="sendQuick('Track my shipment')">📍 Track Shipment</button>
                        <button class="quick-btn" onclick="sendQuick('Talk to an expert')">🎧 Talk to Expert</button>
                    </div>
                </div>
            </div>
        </div>
...
if __name__ == '__main__':
    print("=" * 60)
    print("Aisea - Premium UI 9.5+/10")
    print("Open: http://localhost:5001")
    print("Features: Clean modern UI | 3 main buttons | WhatsApp integration | Smooth animations")
    print("=" * 60)
