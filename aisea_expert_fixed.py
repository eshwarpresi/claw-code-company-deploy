...
<html>
<head>
    <title>Aisea - PAS Freight Expert</title>
    <meta charset="UTF-8">
    ...
    <div id="pasfreight-chat-window">
        ...
        <div class="chat-messages" id="chatMessages">
            <div class="message bot-message">
                <div class="bubble">Hi, I'm Aisea - logistics expert. Ask me about pricing, strategy, or margin optimization.</div>
            </div>
            <div class="message bot-message">
                <div class="bubble">
        ...
        function addSuggestionButtons() {
            ...
            div.innerHTML = `<div class="bubble">
                <div class="suggestion-buttons">
                    ...
                    <button class="suggestion-btn" onclick="sendQuick('Strategy')">📊 Strategy</button>
                    <button class="suggestion-btn" onclick="sendQuick('Margin analysis')">📈 Margin</button>
                </div>
            </div>`;
            messagesDiv.appendChild(div);
            div.scrollIntoView({ behavior: 'smooth' });
...
def chat():
    ...
    if ctx.get('margin'):
        context_display += f", Margin: Rs.{ctx.get('margin')}/kg"
...
DANGEROUS GOODS: User is shipping hazardous items.
...
Give estimated pricing. Keep SHORT (3 lines max).

Example: Air: Rs.400/kg (3-5 days), Sea: Rs.120/kg (25-30 days). Want exact rates?"""
...
User asks business question about: {user_msg}

Think about margin, profit, ROI:
- Calculate if air makes sense given their margin
- Compare PAS Freight vs competitors
- Focus on value
...
Give decision advice with reasoning. Keep SHORT (3 lines max).
...
Example: For 500kg electronics weekly, 70% sea + 30% air balances cost and speed. Want me to design a plan?"""
    ...
    try:
        ...
        return jsonify({'reply': f'Call +91 90361 01201 for assistance. Error: {str(e)}'})
