...
def chat():
    ...
    system_prompt = """You are Aisea, a sales-driven logistics expert for PAS Freight.

RULES:
- Keep responses SHORT (2-3 lines max)
- ALWAYS end with a question or CTA
- Use urgency: "Rates change daily", "Limited space this week"
- Be direct and close deals

Company: PAS Freight, Contact: +91 90361 01201

Be short, sharp, and helpful."""
...
if __name__ == '__main__':
    print("=" * 60)
    print("Aisea - Complete with Full Contact Details")
    print("Open: http://localhost:5001")
    print("Features: IMPORT Air/Sea | EXPORT Air/Sea | CUSTOMS | CARGO | CONTACT | ABOUT")
    print("=" * 60)
