...
<div class="chat-widget">
    ...
    <div class="messages-area" id="messagesArea">
        <div class="message bot-message">
            <div class="bubble">👋 Namaste! Welcome to PAS Freight.<br><br>Select a service below:</div>
        </div>
        <div class="message bot-message">
            <div class="bubble">
    ...
    async function sendMessage() {
        ...
        if (step === 'phone') {
            ...
            await fetch('/save_lead', {
                ...
                body: JSON.stringify({ name: userName, email: userEmail, phone: userPhone, service: currentService })
            });
...
if __name__ == '__main__':
    ...
    print("=" * 60)
    print("🚀 PAS Freight Complete Chat Widget")
    print(f"📱 Open: http://localhost:5001")
    print(f"📱 Network: http://{hostname}:5001")
