...
<body>
    ...
    <div id="pasfreight-chat-window">
        ...
        <div class="quick-buttons">
            <button class="quick-btn" onclick="sendQuick('import')">📥 IMPORT</button>
            <button class="quick-btn" onclick="sendQuick('export')">📤 EXPORT</button>
            <button class="quick-btn" onclick="sendQuick('customs')">📋 CUSTOMS</button>
            <button class="quick-btn" onclick="sendQuick('cargo')">🚚 CARGO</button>
            <button class="quick-btn" onclick="sendQuick('contact')">📞 CONTACT</button>
            <button class="quick-btn" onclick="sendQuick('about')">🏢 ABOUT</button>
        </div>
    ...
    <script>
        ...
        function sendQuick(service) {
            userInput.value = service;
            sendMessage();
        }
...
def chat():
    ...
    service_responses = {
        'import': '📥 IMPORT SERVICES\n\n✈️ Air Freight: 3-7 days\n🚢 Sea Freight: 20-35 days\n\nNeed a quote? Share weight + destination.',
        'export': '📤 EXPORT SERVICES\n\n✈️ Air Freight: 3-7 days\n🚢 Sea Freight: 20-35 days\n\nNeed a quote? Share weight + destination.',
        'customs': '📋 CUSTOMS CLEARANCE\n\nWe handle documentation, duties, and compliance.\n\nCall +91 90361 01201 for expert assistance.',
        'cargo': '🚚 CARGO SERVICES\n\nDomestic & International cargo shipping.\n\nShare details for a quote.',
        'contact': '📞 CONTACT PAS FREIGHT\n\n📱 Phone: +91 90361 01201\n✉️ Email: shivu@pasfreight.com\n📍 Bangalore, India\n\n24/7 Support available.',
        'about': '🏢 PAS FREIGHT SERVICES PVT LTD\n\n📍 Bangalore\'s leading logistics provider\n✅ WCA & GLA Certified\n🌟 8+ years experience\n\nCall +91 90361 01201 for assistance.'
    }
    
    if user_msg.lower() in service_responses:
        return jsonify({'reply': service_responses[user_msg.lower()]})
...
- Use urgency: "Rates change daily", "Limited space today"
- Be direct, close deals
- NEVER repeat "Need weight and destination" - vary your questions

DYNAMIC FOLLOW-UPS (rotate these):
- "Cargo type? Electronics/clothes/machinery?"
- "Urgent or flexible delivery?"
- "Pallets or boxes?"
...
User: "electronics 500kg Germany"
You: "✈️ Air: ₹320-400/kg (3-5 days)\n🚢 Sea: ₹80-120/kg (20-30 days)\n\nShare your number - I'll lock today's best rate. Limited space this week."

Company: PAS Freight, Contact: +91 90361 01201

Be short, sharp, and close deals."""
...
if __name__ == '__main__':
    ...
    print("Features: Service buttons | Short replies | CTAs | Urgency | Dynamic follow-ups")
    print("=" * 60)
