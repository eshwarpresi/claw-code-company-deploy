...
<body>
    <div class="chat">
        ...
        <div class="quick-buttons">
            ...
            <button class="quick-btn" onclick="sendQuick('Shipping rates to Dubai?')">🚢 Shipping Rates</button>
            <button class="quick-btn" onclick="sendQuick('Customs clearance process?')">📋 Customs</button>
            <button class="quick-btn" onclick="sendQuick('Track my shipment')">📍 Track Shipment</button>
        </div>
    ...
    <script>
        ...
        async function send() {{
            ...
            try {{
                ...
                typing.remove();
                addMessage('Sorry, an error occurred. Please try again or contact us directly at +91 9071660066.', false);
            }}
        }}
...
def chat():
    ...
    system_prompt = f"""You are {COMPANY_NAME} AI Assistant. Provide helpful, professional responses about:
...
Company contact: +91 9071660066, +91 9164466664, shivu@pasfreight.com
Address: Site No:171, Arkavathey Layout, 7th Block, Jakkur-BDA, Bangalore - 560092
WCA Member ID: 115513, GLA Member ID: 1166251

Be helpful, professional, and concise. Offer to connect with their team if needed."""
    ...
    try:
        ...
        return jsonify({'reply': f'I apologize, but I encountered an issue. Please contact our team directly at +91 9071660066 or email shivu@pasfreight.com for immediate assistance.'})
